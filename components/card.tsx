...
export default function Card({ name, price, discount, img }: cardProps) {
  return (
    <div style={{background: `url('${img}')`, backgroundSize: 'cover'}} className={`p-4 font-semibold items-center text-white w-60 h-80 rounded-3xl grid grid-cols-5 grid-rows-6`}>
